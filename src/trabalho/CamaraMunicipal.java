...
public class CamaraMunicipal {
    ...
    public CamaraMunicipal(String nome_, String presidente_, String email_, String site_, int telefone_, int nFreguesias_, int area_, int nHabitantes_, String brasao_) {
        counter++;
        this.id = counter;
        this.nome = nome_;
